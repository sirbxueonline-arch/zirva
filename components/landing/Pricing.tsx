...
const PLANS: Plan[] = [
  {
    ...
    features: [
      { text: '1 brend profili',                    included: true  },
      { text: '25 kredit / ay',                     included: true  },
      { text: 'Əsas SEO teqləri (AZ dili)',         included: true  },
      { text: 'Əsas SMO analizi',                   included: true  },
      { text: 'URL-dən avtomatik analiz',           included: true  },
      { text: 'Tam SEO paketi',                     included: false },
  ...
  },
  {
    ...
    prices: {
      ...
      quarterly: { display: '33.99',                  badge: '15% endirim', billing: 'AZN / ay, hər rüb ödənilir' },
      yearly:    { display: '29.99',                  badge: '25% endirim', billing: 'AZN / ay, illik ödənilir' },
    },
    features: [
      { text: '5 brend profili',                         included: true },
      { text: '250 kredit / ay',                         included: true },
      { text: 'Güclü SEO — AZ + RU, Schema, OG, Hreflang', included: true },
      { text: 'Tam SMO — hashteq, kontent, auditoriya',  included: true },
  ...
  },
  {
    ...
    prices: {
      ...
      quarterly: { display: '127.49',                  badge: '15% endirim', billing: 'AZN / ay, hər rüb ödənilir' },
      yearly:    { display: '112.49',                  badge: '25% endirim', billing: 'AZN / ay, illik ödənilir' },
    },
    features: [
      { text: '15 brend profili',               included: true },
      { text: '1000 kredit / ay',               included: true },
      { text: 'Maksimum SEO gücü',              included: true },
      { text: 'Maksimum SMO gücü',              included: true },
      { text: 'Pro-nun bütün imkanları',        included: true },
