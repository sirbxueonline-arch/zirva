      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex items-center justify-between mb-4 sm:hidden">
          <Link href="/history" className="flex items-center gap-1.5 text-sm font-medium py-1"
            style={{ color: '#7B6EF6' }}>
            <ChevronRight size={15} strokeWidth={2.5} className="rotate-180" /> Tarixçəyə qayıt
          </Link>
              ...
              {isPro ? (
                <>
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 rounded-xl text-xs font-medium border transition-all hover:bg-surface-hover flex-1 sm:flex-none"
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 rounded-xl text-xs font-semibold transition-all"
          ...
          <div className="flex gap-1 min-w-max sm:min-w-0">
            {TABS.map(tab => (
              <button
                ...
                className="flex-shrink-0 sm:flex-1 py-2.5 sm:py-2 px-4 sm:px-3 rounded-lg text-sm font-medium transition-all duration-200 relative whitespace-nowrap"
                style={{
