...
const PLAN_FEATURES: Record<string, PlanFeature[]> = {
  free: [
    { Icon: Package,       text: 'Ayda 5 SEO + SMO paketi' },
    { Icon: Globe,         text: 'URL, sosial, manual axışlar' },
    { Icon: Languages,     text: 'Azerbaycanca + Rusca teqlər' },
    { Icon: ClipboardList, text: 'Bütün teq növləri' },
  ],
  pro: [
    { Icon: Package,       text: 'Ayda 50 SEO + SMO paketi' },
    { Icon: Globe,         text: 'Bütün axışlar + post kontent' },
    { Icon: Languages,     text: 'Azerbaycanca + Rusca teqlər' },
  ...
  agency: [
    { Icon: Package,       text: 'Ayda 300 SEO + SMO paketi' },
    { Icon: CheckCircle,   text: 'Pro-nun hər şeyi' },
    { Icon: Globe,         text: 'Çoxlu sayt dəstəyi' },
